    ...
    - table [ref=e56]:
      - rowgroup [ref=e57]:
        - row "Item Description Price Quantity Total" [ref=e58]:
          ...
          - cell [ref=e64]
      - rowgroup [ref=e65]:
        - row "Product Image Men Tshirt Men > Tshirts Rs. 400 1 Rs. 400 " [ref=e66]:
          - cell "Product Image" [ref=e67]:
            - link "Product Image" [ref=e68] [cursor=pointer]:
              - /url: ""
              - img "Product Image" [ref=e69]
          - cell "Men Tshirt Men > Tshirts" [ref=e70]:
            - heading "Men Tshirt" [level=4] [ref=e71]:
              - link "Men Tshirt" [ref=e72] [cursor=pointer]:
                - /url: /product_details/2
            - paragraph [ref=e73]: Men > Tshirts
          - cell "Rs. 400" [ref=e74]:
        ...
        - row "Product Image Stylish Dress Women > Dress Rs. 1500 1 Rs. 1500 " [ref=e83]:
          - cell "Product Image" [ref=e84]:
            - link "Product Image" [ref=e85] [cursor=pointer]:
              - /url: ""
              - img "Product Image" [ref=e86]
          - cell "Stylish Dress Women > Dress" [ref=e87]:
            - heading "Stylish Dress" [level=4] [ref=e88]:
              - link "Stylish Dress" [ref=e89] [cursor=pointer]:
                - /url: /product_details/4
            - paragraph [ref=e90]: Women > Dress
          - cell "Rs. 1500" [ref=e91]:
            - paragraph [ref=e92]: Rs. 1500
          - cell "1" [ref=e93]:
...
```ts
  ...
  36 |   
  37 |   const deleteButton = page.locator('tr',{hasText:'Blue Top'}).locator('a.cart_quantity_delete')
  38 |   await deleteButton.click()
  39 |   const count = await cartPage.getCartItemCount()
  40 |   console.log(`Total items in cart: ${count}`)
> 41 |   expect(count).toBe(2)
     |                 ^ Error: expect(received).toBe(expected) // Object.is equality
  42 |   // const count2 = await cartPage.getCartItemCount()
  43 |   // console.log(`Total items in cart: ${count2}`)
  44 |   // expect(count2).toBe(2)
  45 |   await page.waitForTimeout(10000)
  46 |   await cartPage.checkout()
  47 |   await checkoutPage.verifyAddresses()
  48 |   await paymentPage.placeorder()
  49 |   await paymentPage.fillPaymentDetails(
  50 |     paymentData.cardName,
  51 |     paymentData.cardNumber,
  52 |     paymentData.cvv,
  53 |     paymentData.month,
  54 |     paymentData.year
  55 |   )
  56 |   await orderConfirmationPage.confirmorder()
  57 |   await orderConfirmationPage.orderplaced()
  58 |   await orderConfirmationPage.downloadInvoice()
  59 | 
  60 |   
  61 |  })
  62 | 
